...
static const int64_t COIN_YEAR_REWARD = 100 * CENT; // 50% per year (output to console will be updated)
...
static const uint256 hashGenesisBlock("0xfff4f358e6fe35bb8ca2f137a84daf375c2a7a414520a165184dab1ad5000d43");
static const uint256 hashGenesisBlockTestNet("0x0000bb718576edb7039081063593e532f965022430ba18fae246973715c2afc7");
...
public:
    ...
    {
        // LifeCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // LifeCoin: get transaction coin age
...
public:
    ...
    // LifeCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // LifeCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // LifeCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // LifeCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // LifeCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // LifeCoin: block index flags
    enum  
    {
