...
{
    return GetBoolArg("-testnet", false) ? 41324 : 51324;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop LifeCoin server (and possibly override the detachdb config value).");
