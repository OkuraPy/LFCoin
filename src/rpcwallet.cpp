...
Value walletpassphrase(const Array& params, bool fHelp)
{
    ...
    // LifeCoin: if user OS account compromised prevent trivial sendmoney commands
    if (params.size() > 2)
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <LifeCoinpubkey>\n"
            "Return information about <LifeCoinpubkey>.");
...
// LifeCoin: reserve balance from being staked for network protection
...
// LifeCoin: check wallet integrity
...
// Lifecoin: resend unconfirmed wallet transactions
...
// LifeCoin: make a public-private key pair
...
Value getwalletinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total Lifecoin balance of the wallet\n"
