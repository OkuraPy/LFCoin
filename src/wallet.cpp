...
// LifeCoin: total coins staked (non-spendable until maturity)
...
// Lifecoin: get current stake weight
...
// LifeCoin: check 'spent' consistency between wallet and txindex
// LifeCoin: fix wallet spent state according to txindex
...
// LifeCoin: disable transaction (only for coinstake)
