...
// Copyright (c) 2014 The LifeCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("Lifecoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("Lifecoin-smsg-pow"); // Make this thread recognisable
